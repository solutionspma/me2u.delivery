export const ROLES = ["PLATFORM_ADMIN","PLATFORM_OPERATIONS","DISPATCHER","MERCHANT_OWNER","MERCHANT_MANAGER","MERCHANT_STAFF","COURIER","CUSTOMER","COMPLIANCE_REVIEWER","SUPPORT"] as const;
